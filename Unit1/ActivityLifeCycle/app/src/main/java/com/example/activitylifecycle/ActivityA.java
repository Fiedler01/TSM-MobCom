...
public class ActivityA extends Activity {
    ...
    public void startDialog(View v) {
        Intent intent = new Intent(ActivityA.this, com.example.activitylifecycle.DialogActivity.class);
    ...
    public void startActivityC(View v) {
        Intent intent = new Intent(ActivityA.this, com.example.activitylifecycle.ActivityC.class);
        startActivity(intent);
    }
